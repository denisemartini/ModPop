...
```{r F_plot, , fig.height=7, fig.width=12, out.width="850px"}
palette=(c(rep("#D9EF8B", 13), rep("#1A9850", 14), rep("#66BD63", 10), rep("#A6D96A", 12), 
           rep("#D73027", 7), rep("#F46D43", 11), rep("#FEE08B", 8), rep("#FDAE61", 17)))
...
This is actually really neat, because it highlights very clearly the only individual with het excess from Kapiti Island, which might be a very clear cut sign of genetic drift.
Now, the mean maf.
