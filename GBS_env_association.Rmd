...
obj.lfmm = lfmm("snps_for_env_tests.lfmm_imputed.lfmm", "mean_temp.env", 
                K = 2, repetitions = 10, iterations = 6000, burnin = 3000, project="new", CPU = 8)
obj.lfmm = lfmm("snps_for_env_tests.lfmm_imputed.lfmm", "mean_temp.env", 
                K = 3, repetitions = 10, iterations = 6000, burnin = 3000, project="continue", CPU = 8)
obj.lfmm = lfmm("snps_for_env_tests.lfmm_imputed.lfmm", "mean_temp.env", 
                K = 4, repetitions = 10, iterations = 6000, burnin = 3000, project="continue", CPU = 8)
obj.lfmm = lfmm("snps_for_env_tests.lfmm_imputed.lfmm", "mean_temp.env", 
                K = 5, repetitions = 10, iterations = 6000, burnin = 3000, project="continue", CPU = 8)
```
