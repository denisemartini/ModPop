...
```{r islands, fig.height=15, fig.width=14, out.width=850px}
...
```{r loadings, fig.height=15, fig.width=14, out.width=850px}
contrib <- loadingplot(dapc_isl_opt$var.contr, axis=1, thres=quantile(dapc_isl_opt$var.contr, 0.9999))
```
