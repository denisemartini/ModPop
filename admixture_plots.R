...
pops=read.table("../vcf_filtering/population.txt")
...
pops <- bind_rows(pops[1:52,], pops[54:93,])
...
tbl2=read.table("admix_11/maxmiss90_common_snps.2.Q")
full_tbl2 <- data.frame(pops, tbl2)
...
tbl3=read.table("admix_11/maxmiss90_common_snps.3.Q")
full_tbl3 <- data.frame(pops, tbl3)
...
setwd("/Volumes/osms-anatomy-dept-1/Users/D/Denise Martini/Denise/ModPop_analysis/pop_structure")
tbl4=read.table("admix_11/maxmiss90_common_snps.4.Q")
